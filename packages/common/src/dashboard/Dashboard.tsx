  ...
  render() {
    ...
    return (
      ...
      <div className='dashboard'>
        <Sidebar sidebarVisible={this.state.sidebarVisible} placement={this.state.placement} setVisibility={setVisibility} setPlacement = {setPlacement} {...this.props} >
          <DashboardConfigControl {...this.props} />
        </Sidebar>
        <div className="dashboard-content">
          <div>
            { !this.state.sidebarVisible && React.createElement(MenuFoldOutlined, {

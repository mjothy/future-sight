...
const DEV_TEST_DATA_PATH = path.join(DEV_DATA_DIR, "test-data.json");
...
const PROD_TEST_DATA_PATH = path.join(PROD_DATA_DIR, "test-data.json")
...
const testDataPath = isProd ? PROD_TEST_DATA_PATH : DEV_TEST_DATA_PATH;
...
// data loading
const dataProxy = new FSDataProxy(dataPath, testDataPath, modelsPath, regionsPath, variablesPath);
